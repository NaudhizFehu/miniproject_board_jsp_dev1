...
<p>전화번호 : <input type="text" name="phoneNumber1" style="width:40px">-<input type="text" name="phoneNumber2" style="width:50px">-<input type="text" name="phoneNumber3" style="width:50px"></p>
<c:choose>
